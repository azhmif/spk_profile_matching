    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item @yield('jenis') ">
            <a class="nav-link" href="/jenis">
              <i class="material-icons">person</i>
              <p>Jenis kegiatan</p>
            </a>
          </li>
          <li class="nav-item  @yield('anggaran')">
            <a class="nav-link" href="/anggaran">
              <i class="material-icons">content_paste</i>
              <p>Anggaran Kegiatan</p>
            </a>
          </li>
          <li class="nav-item  @yield('peminat') ">
            <a class="nav-link" href="/peminat">
              <i class="material-icons">library_books</i>
              <p>Peminat Kegiatan</p>
            </a>
          </li>
          <li class="nav-item  @yield('realisasi') ">
            <a class="nav-link" href="/realisasi">
              <i class="material-icons">bubble_chart</i>
              <p>realisasi Kegiatan</p>
            </a>
          </li>
          <li class="nav-item  @yield('kb') ">
            <a class="nav-link" href="/kriteria-bobot">
              <i class="material-icons">bubble_chart</i>
              <p>Kriteria bobot</p>
            </a>
          </li>
          ...
          <li class="nav-item  @yield('profile') ">
            <a class="nav-link" href="/profile-matching">
